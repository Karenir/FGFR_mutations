...
file_path = 'FGFR4_mutations_cosmic.csv' #If you download GitHub package, you have to change the file_path to the path where you store FGFR4_mutations_cosmic.csv
