...
file_path = 'FGFR3_mutations_cosmic.csv' #If you download GitHub package, you have to change the file_path to the path where you store FGFR3_mutations_cosmic.csv
...
print("Stop codons before 782: ", stop_codon_before_782 ['Count'].sum()) #10
print("Frameshift before 782: ", frameshift_before_782 ['Count'].sum()) #59
...
#Mutations influencing S782 with cat site:
...
print("total stop codons w/cat site influencing S782: ", all_stop_codons_cat_tail['Count'].sum()) #0
print("total frameshifts w/cat site influencing S782: ", all_frameshifts_cat_tail['Count'].sum()) #4
print("Insertions/Deletions in frame with catalytic site influencing S771 and/or S782: 0") #manual count
